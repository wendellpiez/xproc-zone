...
MORGANA="${SCRIPT_DIR}/lib/MorganaXProc-IIIse-1.6.4/Morgana.sh"
...
[[ -z "${1-}" ]] && { echo "The script requires an XProc 3 pipeline -"; usage; exit 1; }

if [ ! -f "${MORGANA}" ]; then

  echo "Morgana not found at ${MORGANA} ... try running a setup script ..."
