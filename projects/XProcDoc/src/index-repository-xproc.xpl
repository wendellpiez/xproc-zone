...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" version="3.0"
  ...
  <p:for-each>
    ...
    <p:variable name="tag" select="string(.)">
      <p:inline>[{ p:iteration-position() }/{ p:iteration-size() }]</p:inline>
    </p:variable>
    <p:load href="{ $filepath }" message="LOADING { $tag } { $filepath }" content-type="text/plain"/>
