...
<p:library xmlns:p="http://www.w3.org/ns/xproc"
   ...
   <p:import href="../../lib/schxslt-1.10.1/xproc/3.0/library.xpl"/>
   
   <!-- Providing a relative path to XSpec (top-level directory) on this system. with trailing slash -->   
   <p:option name="xspec-home" select="'../../lib/xspec-3.2.2/'" static="true"/>
   
   <p:declare-step name="execute-xslt-xspec" type="zone:execute-xslt-xspec">      
      ...
      <zone:produce-html-report name="html-report"/>
      <p:sink/>
      
      <zone:produce-junit-report name="junit-report">
         <p:with-input pipe="result@xspec-report"/>
      </zone:produce-junit-report>
   </p:declare-step>
   
   <p:declare-step name="execute-xquery-xspec" type="zone:execute-xquery-xspec">      
      <p:input port="xspec-source" primary="true" content-types="application/xml"/>
      <p:output port="xspec-html-report" primary="true" pipe="result@html-report"/>
      <p:output port="xspec-junit-report" primary="false" pipe="result@junit-report"/>
   ...
   <p:declare-step name="execute-schematron-xspec" type="zone:execute-schematron-xspec">      
      <p:input port="xspec-source" primary="true" content-types="application/xml"/>
   ...
   <p:declare-step name="execute-xspec" type="zone:execute-xspec">
      <p:input port="xspec-source" primary="true" content-types="application/xml"/>
      ...
      <p:choose name="switcher">
         <p:when test="exists(/x:description/@schematron)">
            ...
            <zone:execute-schematron-xspec name="schematron-xspec-execution"/>
         </p:when>
         <p:when test="exists(/x:description/@stylesheet)">
            ...
            <zone:execute-xslt-xspec name="xslt-xspec-execution"/>
         </p:when>
         <p:when test="exists(/x:description/@query)">
            ...
            <zone:execute-xquery-xspec name="xquery-xspec-execution"/>
         </p:when>
         <p:otherwise>
   ...
   <p:declare-step name="produce-html-report" type="zone:produce-html-report">
   ...
   <p:declare-step name="produce-junit-report" type="zone:produce-junit-report">
      <p:input  port="source" primary="true"/>
      <p:output port="result"/>
